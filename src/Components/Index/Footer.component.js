    ...
    <div className="container-footer">
      <div className="container-redes-sociales-footer">
        <div className="container-derechos-reservados-footer">
          <p className="derechos-reservados-footer">Fiesta Provincial del Trigo 2020</p>
          <p className="derechos-reservados-footer">Derechos reservados Fiesta Provincial del Trigo 2020 Copyright ©</p>
        </div>
